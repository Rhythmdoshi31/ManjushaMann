const paras = [
    ...
    "आपने मेरे बारे में जो बताया है वो सच है।और मेरे परिवार वालों के बारे में जो भी बताए सही है। आपने जो उपचार बताएं है उसका पालन कर रहा हूँ। उससे मेरे जीवन में सुंदर हुआ है। बहुत बहुत आभार और धन्यवाद आपको। बहुत अच्छी knowledge है आपको एस्ट्रोलॉजी के बारे में।"
];
...
const names = [
    ...
    {name: "P Naresh Raju", place: "Raipur", imgSrc: "./images/unknown.webp"},
];
